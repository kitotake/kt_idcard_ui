...
export const MOCK_MAIRIE: MairieCardData = {
  ...
  issued:subYears(2), expiry:addYears(3), signature:'I. Fontaine', officialSignature:'Mairie de Los Santos',
}
...
export const MOCK_COMPANY: CompanyCardData = {
  ...
  accessLevel:3, companyLogo:'📡', issued:subYears(1), expiry:addYears(2), signature:'T. Lemaire',
}
...
export const ALL_MOCKS = {
  identity:MOCK_IDENTITY, driver:MOCK_DRIVER, weapon:MOCK_WEAPON,
  police:MOCK_POLICE, mairie:MOCK_MAIRIE, government:MOCK_GOVERNMENT,
  ems:MOCK_EMS, company:MOCK_COMPANY, passport:MOCK_PASSPORT,
  bank_card:MOCK_BANK_CARD, bank_gold_card:MOCK_GOLD_CARD, bank_diamond_card:MOCK_DIAMOND_CARD,
}
