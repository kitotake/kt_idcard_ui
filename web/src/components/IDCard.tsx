      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <div>
          ...
          <div style={{
            ...
            color: t.textPrimary, letterSpacing: 1.5, textTransform: 'uppercase',
            marginTop: 1,
          }}>{t.name}</div>
        </div>
      </div>
    ...
    <CardShell type="identity">
      ...
      <div style={{ padding: '18px 22px', display: 'flex', gap: 18 }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 10 }}>
          ...
          <div>
            <div style={{
              fontFamily: 'Oswald', fontSize: 26, fontWeight: 600,
              color: t.textPrimary, lineHeight: 1, letterSpacing: 1,
            }}>{data.lastname}</div>
            <div style={{
              fontFamily: 'Exo 2', fontSize: 18, fontWeight: 300,
      ...
      {/* Bottom bar */}
      <div style={{
        padding: '8px 22px 12px', borderTop: `1px solid ${t.borderColor}`,
        display: 'flex', justifyContent: 'space-between', alignItems: 'center',
        background: `linear-gradient(90deg, ${t.accent}08, transparent)`,
      }}>
        <Barcode seed={data.uniqueId ?? data.lastname} theme={t} />
        <div style={{ fontFamily: 'Share Tech Mono', fontSize: 9, color: `${t.textSecondary}60`, letterSpacing: 1 }}>
  ...
  return (
    <CardShell type="driver">
      ...
      <div style={{ padding: '18px 22px', display: 'flex', gap: 18 }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 10 }}>
          <div>
            <div style={{ fontFamily: 'Oswald', fontSize: 24, fontWeight: 600, color: t.textPrimary, letterSpacing: 1 }}>
              {data.lastname}
            </div>
            <div style={{ fontFamily: 'Exo 2', fontSize: 16, fontWeight: 300, color: t.accent }}>
              {data.firstname}
            </div>
          </div>
          <Divider theme={t} />
        ...
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'flex-end' }}>
          ...
          <div style={{
            fontFamily: 'Share Tech Mono', fontSize: 9, color: t.textSecondary,
      ...
      <div style={{
        ...
        <div style={{ fontFamily: 'Share Tech Mono', fontSize: 9, color: `${t.textSecondary}60`, letterSpacing: 1 }}>
          MINISTÈRE DES TRANSPORTS • AGENCE NATIONALE
        </div>
      </div>
    </CardShell>
  )
    ...
    <CardShell type="weapon">
      ...
      <div style={{ padding: '18px 22px', display: 'flex', gap: 18 }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 9 }}>
          ...
          <div>
            <div style={{ fontFamily: 'Share Tech Mono', fontSize: 8, color: t.textSecondary, letterSpacing: 1, marginBottom: 4 }}>
              ARMES AUTORISÉES
            </div>
            <div style={{ display: 'flex', gap: 4, flexWrap: 'wrap' }}>
              {data.allowedWeapons.map(w => (
                <span key={w} style={{
                  ...
                  fontFamily: 'Rajdhani', fontSize: 10, color: t.textPrimary,
                }}>{w}</span>
              ))}
            </div>
          </div>
      ...
      <div style={{
        ...
        <Barcode seed={data.licenseNumber} theme={t} />
        <div style={{ fontFamily: 'Share Tech Mono', fontSize: 9, color: `${t.textSecondary}60`, letterSpacing: 1 }}>
          AUTORITÉ NATIONALE DES ARMES • REGISTRE OFFICIEL
        </div>
      </div>
    </CardShell>
  )
      ...
      <div style={{ padding: '16px 22px', display: 'flex', gap: 16 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10, alignItems: 'center' }}>
          ...
          <div style={{
            ...
            <svg viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ position: 'absolute', inset: 0 }}>
            ...
            <span style={{ fontFamily: 'Rajdhani', fontSize: 9, fontWeight: 700, color: '#000', zIndex: 1, textAlign: 'center', lineHeight: 1 }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 8 }}>
          <div>
            <div style={{ fontFamily: 'Rajdhani', fontSize: 10, color: t.accentAlt, letterSpacing: 2, textTransform: 'uppercase' }}>
              {data.rank}
            </div>
            <div style={{ fontFamily: 'Oswald', fontSize: 24, fontWeight: 600, color: t.textPrimary, letterSpacing: 1 }}>
              {data.lastname}
            </div>
            <div style={{ fontFamily: 'Exo 2', fontSize: 15, fontWeight: 300, color: t.textSecondary }}>
              {data.firstname}
            </div>
          </div>
          <Divider theme={t} />
  ...
  return (
    <CardShell type="mairie">
      ...
      <div style={{ padding: '18px 22px', display: 'flex', gap: 18 }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 10 }}>
          ...
          {data.officialSignature && (
            <div style={{
              fontFamily: 'Oswald', fontSize: 13, fontStyle: 'italic',
              color: `${t.accent}90`, marginTop: 4, letterSpacing: 0.5,
            }}>— {data.officialSignature}</div>
          )}
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'flex-end' }}>
      ...
      <div style={{
        ...
        <div style={{ fontFamily: 'Share Tech Mono', fontSize: 9, color: `${t.textSecondary}60`, letterSpacing: 1 }}>
          MAIRIE DE LOS SANTOS • SERVICE ADMINISTRATIF
        </div>
      </div>
    </CardShell>
  )
  ...
  return (
    <CardShell type="government">
      ...
      <CardHeader type="government" rightContent={
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <div style={{
            ...
            background: `${t.stripeColor}20`, border: `1px solid ${t.stripeColor}50`,
          }}>
            <div style={{ fontFamily: 'Share Tech Mono', fontSize: 8, color: t.stripeColor, letterSpacing: 1 }}>
              CLEARANCE
            </div>
            <div style={{ fontFamily: 'Rajdhani', fontSize: 18, fontWeight: 700, color: t.stripeColor, lineHeight: 1 }}>
      ...
      <div style={{ padding: '16px 22px', display: 'flex', gap: 16 }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 9 }}>
          <div>
            <div style={{ fontFamily: 'Share Tech Mono', fontSize: 9, color: t.stripeColor, letterSpacing: 2 }}>
            ...
            <div style={{ display: 'flex', gap: 4, flexWrap: 'wrap' }}>
              {data.specialAuthorizations.map(a => (
                <span key={a} style={{
                  ...
                  background: `${t.stripeColor}18`, border: `1px solid ${t.stripeColor}40`,
                  fontFamily: 'Share Tech Mono', fontSize: 9, color: t.stripeColor,
                }}>{a}</span>
              ))}
            </div>
          </div>
      ...
      <div style={{ padding: '16px 22px', display: 'flex', gap: 16 }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10, alignItems: 'center' }}>
          ...
          <div style={{
            ...
            fontFamily: 'Rajdhani', fontSize: 18, fontWeight: 700, color: '#fca5a5',
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 8 }}>
          <div>
            <div style={{ fontFamily: 'Share Tech Mono', fontSize: 9, color: t.accent, letterSpacing: 2 }}>
              {data.medicalRank.toUpperCase()}
            </div>
            <div style={{ fontFamily: 'Oswald', fontSize: 24, fontWeight: 600, color: t.textPrimary, letterSpacing: 1 }}>
              {data.lastname}
            </div>
...
function CompanyCard({ data }: { data: CompanyCardData }) {
  ...
  return (
    <CardShell type="company">
      <CardHeader type="company" rightContent={
        <div style={{ fontSize: 32 }}>{data.companyLogo ?? '🏢'}</div>
      } />
      <div style={{ padding: '18px 22px', display: 'flex', gap: 16 }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 9 }}>
          <div>
            <div style={{
              fontFamily: 'Share Tech Mono', fontSize: 11, color: t.stripeColor,
      ...
      <div style={{
        ...
        <Barcode seed={data.employeeId} theme={t} />
        <div style={{ fontFamily: 'Share Tech Mono', fontSize: 9, color: `${t.textSecondary}60`, letterSpacing: 1 }}>
          {data.company.toUpperCase()} • OFFICIAL EMPLOYEE BADGE
        </div>
      </div>
    </CardShell>
  )
    ...
    <CardShell type="passport">
      ...
      <CardHeader type="passport" rightContent={
        <div style={{ textAlign: 'right' }}>
          ...
          <div style={{ fontFamily: 'Share Tech Mono', fontSize: 14, color: t.textPrimary, letterSpacing: 2 }}>
            {data.passportNumber}
          </div>
        </div>
      } />
      <div style={{ padding: '16px 22px', display: 'flex', gap: 18 }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 9 }}>
          <div>
            ...
            <div style={{ fontFamily: 'Oswald', fontSize: 26, fontWeight: 600, color: t.textPrimary, letterSpacing: 1 }}>
              {data.lastname}
            </div>
            <div style={{ fontFamily: 'Exo 2', fontSize: 16, fontWeight: 300, color: t.textSecondary }}>{data.firstname}</div>
          </div>
      ...
      {/* MRZ zone */}
      <div style={{
        background: 'rgba(0,0,0,0.45)', borderTop: `1px solid ${t.borderColor}`,
        ...
        {data.mrz.split('\n').map((line, i) => (
          <div key={i} style={{
            fontFamily: 'Share Tech Mono', fontSize: 10, color: `${t.textPrimary}80`,
            letterSpacing: 2, lineHeight: 1.6, wordBreak: 'break-all',
          }}>{line}</div>
        ))}
      </div>
    </CardShell>
